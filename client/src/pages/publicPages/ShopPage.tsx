...
export default function ShopPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 md:gap-0 w-full min-h-screen relative">
      ...
      <div
        className={` order-1 md:order-none md:w-1/4 w-full p-4 rounded-b-2xl transition-all duration-300 ease-in-out ${
          showSearch
            ? "block bg-white text-black shadow-2xl mt-10 h-124"
            : "h-0 overflow-hidden"
        } md:block fixed md:static top-0 left-0 h-0 z-10 md:h-auto md:z-auto`}
